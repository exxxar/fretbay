        ...
        Dt = function() {
            ...
            return n.next = function() {
                ...
                if (!(t > this._items.length - 1 || t < 0))
                    if (this._isSliding) F.one(this._element, Ct, (function() {
                        return e.to(t)
                    }));
                    else {
                ...
                if (t === kt ? (n = "carousel-item-left", i = "carousel-item-next", o = "left") : (n = "carousel-item-right", i = "carousel-item-prev", o = "right"), l && l.classList.contains(St)) this._isSliding = !1;
