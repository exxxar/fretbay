                            ...
                            <div class="col-md-12">
                                <form action="">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        >
                                        <label class="custom-control-label" for="customCheck1">{{$trans('profile.settings.label_4')}}</label>
                                    </div>
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        >
                                        <label class="custom-control-label" for="customCheck2">{{$trans('profile.settings.label_5')}}</label>
                                    </div>
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        >
                                        <label class="custom-control-label" for="customCheck3">{{$trans('profile.settings.label_6')}}</label>
                                    </div>
<!--
                                    <div class="form-group text-center">
                                        <button class="btn btn-success btn-standard">{{$trans('profile.settings.button_1')}}</button>
                                    </div>-->
                                </form>
                            </div>
                        </div>
