<template>
    <section id="profile-wizard2" style="min-height:100vh; padding-top:30px; display: flex;">
        <div class="row w-100 mx-auto mt-2 mt-sm-3 h-100 text-center justify-content-center">
            <div class="col-12 col-md-6">
                ...
                <h2 class="step-title" style="color:#21c87a; font-weight: 700">{{
                    $trans('profile.wizard.step_1.h2_1')}}</h2>
                <p class="info-box" v-html=" $trans('profile.wizard.step_1.p_1')"></p>
                <a href="/transporter/profile/transporter-wizard/step-2" class="btn btn-success w-100 mb-3"
                   style="max-width: 300px;">{{ $trans('profile.wizard.step_1.a_1')}}</a>
            </div>
            <div class="col-12 col-md-6">
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <ValidationObserver v-slot="{invalid}">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <ValidationProvider name="ID card number" rules="required" v-slot="{ errors }">
                                            <label for=""
                                                   class="text-lg">{{$trans('profile.wizard.step_1.label_1')}}</label>
                                            <input type="text" class="form-control-empty form-control"
                                                   v-model="edit_manager_card.id_card_number"
                                                   :placeholder="$trans('profile.wizard.step_1.input_placeholder_1')">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <ValidationProvider name="Issue date" rules="required" v-slot="{ errors }">
                                            <label for=""
                                                   class="text-lg">{{$trans('profile.wizard.step_1.label_2')}}</label>
                                            <input type="text" class="form-control-empty form-control"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <ValidationProvider name="Expiry date" rules="required" v-slot="{ errors }">
                                            <label for=""
                                                   class="text-lg">{{$trans('profile.wizard.step_1.label_3')}}</label>
                                            <input type="text" class="form-control-empty form-control"
                                ...
                                <div class="col-12">
                                    ...
                                    <multi-upload-files ref="mn" :files="edit_manager_card.new_images">
                                        <template v-slot:uploadButton>
                                            <button class="btn btn-primary w-100" @click="startUpload('mn')">
                                                {{$trans('profile.wizard.step_1.button_1')}}
                                            </button>
                                        </template>
                                                ...
                                                <div class="card my-2">
                                                    ...
                                                    <div class="card-body px-md-2 text-center">
                                                        <button class="btn btn-outline-blue mt-2 mx-auto w-100"
                                                            ...
                                                            {{$trans('profile.wizard.step_1.button_2')}}
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row w-100 m-auto"
                                         v-if="edit_manager_card.new_images.length===0 && edit_manager_card.document_images===0">
                            ...
                            <div class="row mx-auto mt-2 w-100 justify-content-end">
                                <button class="btn btn-primary px-4 mx-1" :disabled="invalid||loadingManagerCard"
                                        @click="confirm">
