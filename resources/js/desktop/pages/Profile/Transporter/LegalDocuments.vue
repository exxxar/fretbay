            ...
            <div class="col-md-12">
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="row w-100 mx-auto align-items-center">
                            <div class="col-12 p-0 d-block d-md-none">
                                ...
                                <div class="row w-100 mx-auto align-items-center justify-content-end" v-if="!documents.company_info.is_approved">
                                    ...
                                    <span class="text-uppercase">Not approved</span>
                                </div>
                            </div>
                            <div class="col-12 col-sm-8 p-0">
                                <h2 class="tab-title">Legal documents</h2>
                            </div>
                        ...
                        <h4 class="tab-subtitle tab-subtitle-left">Legal information of your company</h4>
                        <div class="row w-100 mx-auto" v-if="!editCompanyInfoMode&& documents.company_info">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="" class="text-lg">First name of the manager</label>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="" class="text-lg">Last name of the manager</label>
                                    <input type="text" class="form-control-empty form-control"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="" class="text-lg">Trade register ID number</label>
                                    <input type="text" class="form-control-empty form-control"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="" class="text-lg">Date of creation</label>
                                    <input type="text" class="form-control-empty form-control"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="" class="text-lg">Postal code</label>
                                    <input type="text" class="form-control-empty form-control"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="" class="text-lg">Country</label>
                                    <input type="text" class="form-control-empty form-control"
                                           v-model="documents.company_info.country" disabled>
                                </div>
                            </div>
                            <div class="col-12">
                                <h4>Document prouvant l'existance réelle de votre société</h4>
...
<!--                                    </div>-->
                                    <multi-upload-files ref="lg" :files="edit_company_info.new_images">
                                        <template v-slot:uploadButton>
                                            <button class="btn btn-primary w-100" @click="startUpload('lg')">Click to upload</button>
                                        </template>
...
<!--                                    <multi-upload-files :files="edit_company_info.document_images"></multi-upload-files>-->
                                ...
                                <div class="col-12">
                                    <h4>You must leave comment about reason for editing this information</h4>
    ...
    <!--                        <div class="col-12">-->
                            <div class="row mx-auto mt-2 w-100 justify-content-end">
                                <button class="btn btn-outline-blue mx-1" v-if="!editCompanyInfoMode" @click="editCompanyInfo">Edit</button>
                                <button class="btn btn-outline-blue mx-1" v-if="editCompanyInfoMode" :disabled="loadingCompanyInfo" @click="editCompanyInfoMode=false">Cancel</button>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="row w-100 mx-auto align-items-center">
                            ...
                            <div class="col-12 col-sm-8 p-0">
                                <h2 class="tab-title">Manager's ID card</h2>
                            </div>
                            <div class="col-12 col-sm-4 p-0 d-none d-md-block">
                                <div class="row w-100 mx-auto align-items-center justify-content-end" v-if="documents.manager_card.is_approved">
                                    <img src="/images/profile/approved.png" class="mx-1" style="width: 25px; height: 25px" alt="">
                        ...
                        <h4 class="tab-subtitle tab-subtitle-left">Manager's ID card</h4>
                        <ValidationObserver v-slot="{invalid}">
...
<!--                                    <multi-upload-files :files="edit_manager_card.document_images"></multi-upload-files>-->
                            ...
                            <div class="row mx-auto mt-2 w-100 justify-content-end">
                                <button class="btn btn-outline-blue mx-1" v-if="!editManagerCardMode" @click="editManagerCard">Edit</button>
                                <button class="btn btn-outline-blue mx-1" v-if="editManagerCardMode" :disabled="loadingManagerCard" @click="editManagerCardMode=false">Cancel</button>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="row w-100 mx-auto align-items-center">
                            ...
                            <div class="col-12 col-sm-8 p-0">
                                <h2 class="tab-title">Transport license</h2>
                            </div>
                            <div class="col-12 col-sm-4 p-0 d-none d-md-block">
                                <div class="row w-100 mx-auto align-items-center justify-content-end" v-if="documents.transport_license.is_approved">
                                    <img src="/images/profile/approved.png" class="mx-1" style="width: 25px; height: 25px" alt="">
                        ...
                        <h4 class="tab-subtitle tab-subtitle-left">Transport license</h4>
                        <ValidationObserver v-slot="{invalid}">
                            <div class="row" v-if="!editTransportLicenseMode">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="" class="text-lg">License number</label>
                                        <input type="text" class="form-control-empty form-control"
                                ...
                                <div class="col-12">
                                    <h4>Document officiel de la licence de transport</h4>
...
<!--                                    <multi-upload-files :files="edit_transport_license.new_images"></multi-upload-files>-->
                                    <multi-upload-files ref="tl" :files="edit_transport_license.new_images">
                                        <template v-slot:uploadButton>
                                            <button class="btn btn-primary w-100" @click="startUpload('tl')">Click to upload</button>
                                        </template>
                                        <template v-slot:filesListAdditional>
                                            <div v-for="(file, key) in edit_transport_license.document_images" class="col-md-4 col-sm-6 col-6 px-1 px-sm-2">
                                                <div class="card my-2">
...
<!--                                    <multi-upload-files :files="edit_transport_license.document_images"></multi-upload-files>-->
                            ...
                            <div class="row mx-auto mt-2 w-100 justify-content-end">
                                <button class="btn btn-outline-blue mx-1" v-if="!editTransportLicenseMode" @click="editTransportLicense">Edit</button>
                                <button class="btn btn-outline-blue mx-1" v-if="editTransportLicenseMode" :disabled="loadingTransportLicense" @click="editTransportLicenseMode=false">Cancel</button>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="row w-100 mx-auto align-items-center">
                            ...
                            <div class="col-12 col-sm-8 p-0">
                                <h2 class="tab-title">Certificate of pro. insurance</h2>
                            </div>
                            <div class="col-12 col-sm-4 p-0 d-none d-md-block">
                                <div class="row w-100 mx-auto align-items-center justify-content-end" v-if="documents.certificate_insurance.is_approved">
                                    <img src="/images/profile/approved.png" class="mx-1" style="width: 25px; height: 25px" alt="">
