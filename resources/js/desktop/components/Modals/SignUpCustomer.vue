<template>
    <div class="modal fade" id="signUp-customer" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
         aria-hidden="true">
