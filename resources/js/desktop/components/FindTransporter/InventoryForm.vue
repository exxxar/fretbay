        ...
        <div style="position:sticky; top:30px;z-index:100;background:white;">
            <div class="row w-100 m-auto">
                ...
                <div class="col-12 col-sm-5">
                    <p class="mt-2 text-sm-right text-center" style="line-height: 200%;">
                        {{ $trans('request_a_quote.section_3.p_1') }} {{ volumeCartTotalVolume.toFixed(2) }} <em
                        class="text-bold">m<sup>3</sup></em>
                        <a href="#reset" v-if="volumeCartTotalVolume>0" class="btn btn-link color-primary p-0 ml-2"
                           @click="resetVolume"><i class="far fa-trash-alt"></i></a></p>
