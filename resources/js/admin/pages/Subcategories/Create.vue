<template>
    <form class="row w-100 m-auto justify-content-center align-items-center" v-on:submit.prevent="submit">
        ...
        <div class="col-12">
            <button class="btn btn-outline-info" type="submit">Create new subcategory</button>
        </div>
    </form>
</template>
    ...
    export default {
        ...
        methods: {
            submit() {
                ...
                axios.post("/admin/subcategories/add", this.json)
                    .then(resp => {
                        this.sendMessage("Success subcategory create!")
                    }).catch((e) => {
