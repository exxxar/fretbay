...
<!--                    </b-button> -->
                    <b-button @click="edit(data.item)" class="btn btn-info mr-1 mb-1">
...
<script>
    export default {
        name: "Index",
        props: ['translations','languages', 'groups'],
        data() {
            return {
                sortBy: 'group',
                sortDesc: false,
        ...
        mounted() {
            this.languages.forEach( (item) => {
                this.fields.push({key: item.locale_name, label: item.name, sortable: true, sortDirection: 'desc'})
            });
            this.fields.push({key: 'action', label: 'Действия'});
        },
        methods: {
