    ...
    export default {
        ...
        methods: {
            update() {
                ...
                window.location.href = `/admin/categories/edit/${this.selected_id}`
            },
            show() {
                if (!this.selected_id || this.selected_id === "") {
                    this.sendMessage("Не указан ID")
                ...
                window.location.href = `/admin/categories/show/${this.selected_id}`
            },
            remove() {
                if (!this.selected_id || this.selected_id === "") {
                    this.sendMessage("Не указан ID")
                ...
                axios.delete(`/admin/categories/delete/${this.selected_id}`)
                    .then(resp => {
