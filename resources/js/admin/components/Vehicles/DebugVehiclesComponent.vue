        ...
        <div class="row mb-1">
            ...
            <div class="col-6">
                <div class="btn-group" role="group" aria-label="Basic example">
                    ...
                    <a href="/admin/vehicles/add" class="btn btn-secondary">Create</a>
    ...
    export default {
        ...
        methods: {
            update() {
                ...
                window.location.href = `/admin/vehicles/edit/${this.selected_id}`
            },
            show() {
                if (!this.selected_id || this.selected_id === "") {
                    this.sendMessage("Не указан ID")
                ...
                window.location.href = `/admin/vehicles/show/${this.selected_id}`
            },
            restore() {
                if (!this.selected_id || this.selected_id === "") {
                    this.sendMessage("Не указан ID")
                ...
                window.location.href = `/admin/subcatgories/show/${this.selected_id}`
            },
            remove() {
                if (!this.selected_id || this.selected_id === "") {
                    this.sendMessage("Не указан ID")
                ...
                axios.delete(`/admin/vehicles/delete/${this.selected_id}`)
                    .then(resp => {
