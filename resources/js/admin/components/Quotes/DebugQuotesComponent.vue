    ...
    export default {
        ...
        methods: {
            update() {
                ...
                window.location.href = `/admin/quotes/edit/${this.selected_id}`
            },
            show() {
                if (!this.selected_id || this.selected_id === "") {
                    this.sendMessage("Не указан ID")
                ...
                window.location.href = `/admin/quotes/show/${this.selected_id}`
            },
            restore() {
                if (!this.selected_id || this.selected_id === "") {
                    this.sendMessage("Не указан ID")
                ...
                window.location.href = `/admin/quotes/restore/${this.selected_id}`
            },
            remove() {
                if (!this.selected_id || this.selected_id === "") {
                    this.sendMessage("Не указан ID")
                ...
                axios.delete(`/admin/quotes/delete/${this.selected_id}`)
                    .then(resp => {
