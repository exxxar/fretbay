    ...
    export default {
        ...
        methods: {
            update() {
                ...
                window.location.href = `/admin/reviews/edit/${this.selected_id}`
            },
            show() {
                if (!this.selected_id || this.selected_id === "") {
                    this.sendMessage("Не указан ID")
                ...
                window.location.href = `/admin/reviews/show/${this.selected_id}`
            },
            restore() {
                if (!this.selected_id || this.selected_id === "") {
                    this.sendMessage("Не указан ID")
                ...
                window.location.href = `/admin/reviews/restore/${this.selected_id}`
            },
            remove() {
                if (!this.selected_id || this.selected_id === "") {
                    this.sendMessage("Не указан ID")
                ...
                axios.delete(`/admin/reviews/delete/${this.selected_id}`)
                    .then(resp => {
