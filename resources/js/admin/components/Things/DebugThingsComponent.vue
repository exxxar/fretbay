        ...
        <div class="row mb-1">
            ...
            <div class="col-6">
                <div class="btn-group" role="group" aria-label="Basic example">
                    ...
                    <a href="/admin/things/add" class="btn btn-secondary">Create</a>
    ...
    export default {
            ...
            filteredJsonData() {
                ...
                this.jsonData.data.forEach(item => {
                    ...
                    if (item.id == this.search ||
                        ...
                        item.slug.trim().toLowerCase().indexOf(this.search) !== -1
        ...
        methods: {
            update() {
                ...
                window.location.href = `/admin/things/edit/${this.selected_id}`
            },
            show() {
                if (!this.selected_id || this.selected_id === "") {
                    this.sendMessage("Не указан ID")
                ...
                window.location.href = `/admin/things/show/${this.selected_id}`
            },
            restore() {
                if (!this.selected_id || this.selected_id === "") {
                    this.sendMessage("Не указан ID")
                ...
                window.location.href = `/admin/things/restore/${this.selected_id}`
            },
            remove() {
                if (!this.selected_id || this.selected_id === "") {
                    this.sendMessage("Не указан ID")
                ...
                axios.delete(`/admin/things/delete/${this.selected_id}`)
                    .then(resp => {
