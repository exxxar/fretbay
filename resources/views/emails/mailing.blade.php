                ...
                <tr>
                    <td class="button">
                        <div><!--[if mso]>
                            ...
                            <![endif]--><a class="button-mobile" href="https://allotrans.com"
                                           style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">Open web site</a>
                        </div>
                    </td>
                </tr>
                </tbody>
