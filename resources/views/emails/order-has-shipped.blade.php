    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
        <center>
            <table cellspacing="0" cellpadding="0" width="600" class="w320">
                ...
                <tr>
                    <td class="header-lg">
                        Thank you for your order! Your order was already Shipped!
                    </td>
                </tr>
                <tr>
                    <td class="free-text">
                        ...
                        <p>Place of loading {{$place_of_loading->place_name}} (postal code {{$place_of_loading->postal}})</p>
                        <p>Place of deliver {{$place_of_delivery->place_name}} (postal code {{$place_of_loading->postal}})</p>
