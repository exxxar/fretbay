    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
        <center>
            <table cellspacing="0" cellpadding="0" width="600" class="w320">
                ...
                <tr>
                    <td class="free-text">
                        Upgrade to a full account and receive the best deals available as soon as they go on. Not only that but you'll get <strong>free shipping</strong> on all your purchases. Find out what you've been missing!
                    </td>
                </tr>
                <tr>
                    <td class="button">
                                                    ...
                                                    <tr>
                                                        <td style="padding: 15px;">
                                                            <div><!--[if mso]>
                                                                ...
                                                                <![endif]--><a class="button-width" href="http://" style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;-webkit-text-size-adjust:none;mso-hide:all;">View Now!</a></div>
                                                        </td>
                                                    </tr>
                                                    </tbody></table>
                                            </td>
