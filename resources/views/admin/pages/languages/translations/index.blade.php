...
{{--                    @include('forms.search', ['name' => 'filter', 'value' => Request::get('filter')])--}}

{{--                    @include('forms.select', ['name' => 'language', 'items' => $languages, 'submit' => true, 'selected' => $language])--}}

{{--                    <div class="sm:hidden lg:flex items-center">--}}

{{--                    @include('forms.select', ['name' => 'group', 'items' => $groups, 'submit' => true, 'selected' => Request::get('group'), 'optional' => true])--}}
